...
<link href="${rootPath}/static/css/freeview.css?ver=2021-06-15-004"
	rel="stylesheet" />
</head>
<body>
			<div id="view_tit">
			...
			<div class="main_cont">
				<p id="content">오늘 이거 먹었다 맛있었다 아무튼 그랬다 오늘 이거 먹었다 <br>맛있었다 아무튼 그랬다 오늘 이거 먹었다 맛있었다 아무튼 그랬다오늘 이거 먹었다 맛있었다 아무튼 그랬다</p>
				<p id="ex_image"><img src="${rootPath}/static/img/11.jpg"></p>
			</div>
